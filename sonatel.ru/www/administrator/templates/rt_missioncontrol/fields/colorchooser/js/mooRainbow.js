 ...
 */
var Rainbows=[];var MooRainbow=new Class({options:{id:"mooRainbow",prefix:"moor-",imgPath:"images/",startColor:[255,0,0],wheel:false,transparent:1,onComplete:$empty,onChange:$empty},initialize:function(c,d){this.element=document.id(c);
...
l=(k=="int")?(l/2).toInt():l;i=(k=="int")?(i/2).toInt():i;m={w:i,h:l};}return m;}});MooRainbow.implement(new Options);MooRainbow.implement(new Events);
