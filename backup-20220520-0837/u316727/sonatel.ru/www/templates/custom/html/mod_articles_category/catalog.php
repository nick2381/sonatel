...
<ul class="models-list category-module<?php echo $moduleclass_sfx; ?>">
	<?php foreach ($list as $group_name => $group) : ?>	
	<li>		
		<?= $group_name ?>
		<ul>
			<?php foreach ($group as $item) : 
				$attr_type_year = trim($item->params->get('attr_type_year'));
			    ...
			    <?php if ($attr_type_year != '') { ?>
						(Вывод атрибута: <?= $attr_type_year ?>)
					<?php }?>
