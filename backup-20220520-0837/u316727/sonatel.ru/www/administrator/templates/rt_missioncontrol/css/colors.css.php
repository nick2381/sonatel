...
/* tab background */
#mc-status li,.disabled .mc-button a, #mc-frame .disabled .mc-button a:hover,#mc-status ul.disabled li:hover, #mc-status ul.disabled li.action:hover, #mc-status ul.disabled ul.disabled li.standard:hover, #mc-status ul.disabled li:hover .select-list,#mc-status li.mdropdown,#mc-submenu ul,.menutop li .item,.menutop.disabled li.root > span.item:hover,.menutop.disabled li:hover > .item {background:<?php echo $tab_bg_color;?>;}
...
/* Legacy Toolbar Stuff */
#mc-title table.toolbar td.button a:hover {background:<?php echo $hover_bg_color;?> !important;color:<?php echo $hover_text_color;?> !important}
